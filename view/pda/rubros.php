...
<div class="box-header with-border">
    ...
    <button class="btn btn-xs btn btn-success" id="btnNuevo"> Nuevo rubro</button>
    <br>
  </div>
        ...
        ?>
          <tr>
            ...
            <td style="text-align: center;">
              ...
              onclick="accion_rubro('C','<?php echo $fila['clave']?>')">
              ...
              onclick="accion_rubro('U','<?php echo $fila['clave']?>')">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    e.preventDefault();
    form('../view/pda/frm_nuevoRubro.php');

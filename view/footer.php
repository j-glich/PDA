  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Procesando datos...</h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4"></div>
          <div class="col-md-4">
            <div class="overlay" style="font-size: 50px;">
          ...
          <p>Guardando... Espere un momento por favor</p>
      </div>
...
<!-- jvectormap -->
<script src="../public/lib/js/jquery-jvectormap-1.2.2.min.js"></script>
<script src="../public/lib/js/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="../public/lib/js/jquery.knob.min.js"></script>
<script src="../public/lib/js/daterangepicker.js"></script>
<!-- datepicker -->
<script src="../public/lib/js/bootstrap-datepicker.min.js"></script>
<!-- daterangepicker -->
<script src="../public/lib/js/moment.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="../public/lib/js/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<!-- Libreria para el uso de data tables -->
